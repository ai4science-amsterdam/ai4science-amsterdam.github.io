...
We develop and use machine learning techniques to discover patterns in data streams produced by experiments in a wide variety of scientific fields, ranging from ecology to molecular biology and from chemistry to astrophysics.">
	...
	<link rel="canonical" href="http://127.0.0.1:4000//assets/xslt/atom.xslt">
...
<div id="navigation" class="sticky">
  <nav class="top-bar" role="navigation" data-topbar>
    <ul class="title-area">
      <li class="name">
      <h1 class="show-for-small-only"><a href="http://127.0.0.1:4000/" class="icon-tree"> AI4Science Lab</a></h1>
    </li>
...
<!-- ***** 25-1-2023: "menu-icon" removed by Bernd after failing to change its color to white in _sass/foundation-components/_top-bar.scss (look for "menu-icon" and "hamburger icon") *****  -->
    ...
    <section class="top-bar-section">
      ...
      <ul class="right">
              ...
              <li class="divider"></li>
              <li><a  href="http://127.0.0.1:4000//research/">Research</a></li>
              ...
              <li class="has-dropdown">
                <a  href="http://127.0.0.1:4000//education/">Education</a>
                  ...
                  <ul class="dropdown">
                      ...
                      <li><a  href="http://127.0.0.1:4000//education/#bachelor">Bachelor courses</a></li>
                    

                      

                      <li><a  href="http://127.0.0.1:4000//education/#master">Master courses</a></li>
                    

                      

                      <li><a  href="http://127.0.0.1:4000//education/#projects">Student Research Projects</a></li>
                    

                      

                      <li><a  href="http://127.0.0.1:4000//education/#teachers">For UvA teachers</a></li>
              ...
              <li class="divider"></li>
              <li class="has-dropdown">
                <a  href="http://127.0.0.1:4000//events/">Events</a>
                  ...
                  <ul class="dropdown">
                      ...
                      <li><a  href="http://127.0.0.1:4000//events/#meetings">Meetings</a></li>
                    

                      

                      <li><a  href="http://127.0.0.1:4000//events/#colloquium">Colloquia</a></li>
                    

                      

                      <li><a  href="http://127.0.0.1:4000//events/#archive">News and Events Archive</a></li>
              ...
              <li class="divider"></li>
              <li class="has-dropdown">
                <a  href="http://127.0.0.1:4000//publications/">Publications</a>
                  ...
                  <ul class="dropdown">
                      ...
                      <li><a  href="http://127.0.0.1:4000//publications/">Papers</a></li>
              ...
              <li class="divider"></li>
              <li><a  href="http://127.0.0.1:4000//contact/">Contact</a></li>
      ...
      <ul class="left">
              ...
              <li class="has-dropdown">
                <a  href="http://127.0.0.1:4000//">AI4Science</a>
                  ...
                  <ul class="dropdown">
                      ...
                      <li><a  href="http://127.0.0.1:4000//consortium/">Consortium</a></li>
                    

                      

                      <li><a  href="http://127.0.0.1:4000//lab/">Lab</a></li>
              ...
              <li class="has-dropdown">
                <a  href="http://127.0.0.1:4000//ai4smm_home/">AI4SMM</a>
                  ...
                  <ul class="dropdown">
                      ...
                      <li><a  href="http://127.0.0.1:4000//ai4smm_rpa/">About</a></li>
                    

                      

                      <li><a  href="http://127.0.0.1:4000//ai4smm_people/">People</a></li>
                    

                      

                      <li><a  href="http://127.0.0.1:4000//ai4smm_students/">Bachelor / Master projects</a></li>
                    

                      

                      <li><a  href="http://127.0.0.1:4000//ai4smm_events/">AI4SMM Events</a></li>
...
<div id="masthead-no-image-header">
	<div class="row">
		<div class="small-12 columns">
			<a id="logo" href="http://127.0.0.1:4000/" title="AI4Science Lab – Where AI meets Science.">
				<img src="http://127.0.0.1:4000//assets/img/logo.png" alt="AI4Science Lab – Where AI meets Science.">
			</a>
...
We develop and use machine learning techniques to discover patterns in data streams produced by experiments in a wide variety of scientific fields, ranging from ecology to molecular biology and from chemistry to astrophysics.
              <a href="http://127.0.0.1:4000///lab">More ›</a>
            </p>
          </div><!-- /.large-6.columns -->
          ...
          <div class="small-6 medium-3 large-3 large-offset-1 columns">
              ...
              <ul class="no-bullet shadow-black">
                  ...
                  <li >
                    <a href="http://127.0.0.1:4000/"  title=""></a>
                  </li>
                  ...
                  <li >
                    <a href="http://127.0.0.1:4000//"  title="Take me home country roads">AI4Science home</a>
                  </li>
          ...
          <div class="small-6 medium-3 large-3 columns">
            ...
            <ul class="no-bullet shadow-black">
                ...
                <li >
                  <a href="http://127.0.0.1:4000/"  title="Visit us">Visiting Adress: <br/> Science Park 904 <br/> 1098 XH Amsterdam</a>
                </li>
            
              
                <li >
                  <a href="http://127.0.0.1:4000/"  title="">Postal Address: <br/> University of Amsterdam <br/> AI4Science Lab <br/> P.O. Box 94323 <br/> 1090 GH Amsterdam <br/> The Netherlands</a>
                </li>
            
              
                <li >
                  <a href="http://127.0.0.1:4000/"  title="">Tel: +31 (0)20 525 7519</a>
                </li>
            
              
                <li >
                  <a href="http://127.0.0.1:4000/"  title="">Email: ai4science.info@gmail.com</a>
                </li>
